...
// ==========================================
void vprint(const char* format, va_list args) { printf("[QGPU]: "); vprintf(format, args); printf("\n"); }
void print(const char* format, ...) {  va_list args; va_start(args, format); vprint(format, args); va_end(args); }
// ==========================================
